...
class SignUpForm_Company extends Component {
    constructor(props) {
        super(props);
        ...
        <div className="FormCenter">
            ...
            <form onSubmit={this.handleSubmit} className="FormFields">
              ...
              <div className="FormField">
                <label className="FormField__Label" htmlFor="text">Name of Company</label>
              ...
              <div className="FormField">
                <label className="FormField__Label" htmlFor="text">Trade License Number</label>
                <input type="text" id="trade_lic_no" className="FormField__Input" placeholder="Enter your trade license number" name="trade_lic_no" value={this.state.trade_lic_no} onChange={this.handleChange} />
                {this.state.trade_Error ? (<div className = "valid">*Please Enter a valid Trade License Number</div>) : null}
              </div>
              <div className="FormField">
              ...
              <div className="FormField">
                <label className="FormField__CheckboxLabel">
                    <input className="FormField__Checkbox" type="checkbox" name="hasAgreed" value={this.state.hasAgreed} onChange={this.handleChange} /> I agree all statements in <Link to = "/sign-up-company" className="FormField__TermsLink">terms of service</Link>
                </label>
              </div>
...
export default SignUpForm_Company;
